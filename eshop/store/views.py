...
def product_detail(request, slug):
    ...
    print("cate offerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")

    # print(producttable.category.categoryoffer)
...
def home(request, c_slug=None):
    ...
    max_offer_category = max(cat, key=lambda category: category.categoryoffer or 0)
    ...
    # if you want more picure from the carousel_banners at that time uncommet the bellowand change the samll thigs to html
    # now the  images shows how mant offer avila
    ...
    context = {
        ...
        'ct': cat,
        'product': product,
        'max_offer_category': max_offer_category,
